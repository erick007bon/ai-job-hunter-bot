# Cover Letter - Cloud Software Architect (Node.js and React.js) - Remote @ General Dynamics Information Technology

**Fuente:** Google Jobs (Indeed) | **Email contacto:** None

**URL:** https://www.indeed.com/viewjob?jk=461cf5f7af90d01c

---

Dear General Dynamics Information Technology team,

I am writing to apply for the Cloud Software Architect (Node.js and React.js) - Remote position. I am an Economist and Data Scientist with dual academic training (Economics + Data Science & AI Engineering), with hands-on experience in Python, Machine Learning, SQL, and AI-powered automation.
